...
namespace Domain.Servicos
{
    public class DespesaServico : IDespesaServico
    {
        ...
        public async Task<object> CarregaGraficos(string emailUsuario)
        {
            ...
            var despesas_pagas = despesasUsuario.Where(d=>d.Pago && d.TipoDespesa == Entities.Enums.EnumTipoDespesa.Contas).Sum(x => x.Valor);
            var despesas_pendentes = despesasUsuario.Where(d => !d.Pago && d.TipoDespesa == Entities.Enums.EnumTipoDespesa.Contas).Sum(x => x.Valor);
